...
int launch_game(void) {
    // int *level = get_level("level/runner1.runner");
    ...
    sprite_t but_sprite1 = load_n_size(my_images.button_path,
                                       ...
                                       scale);
    sprite_t but_sprite2 = load_n_size(my_images.button_path,
                                       initialise_sffloatrect(0, 0, 276, 44),
                                       initialise_sfintrect(0, 0, 138, 44),
                                       scale);
    sprite_t but_sprite3 = load_n_size(my_images.button_path,
                                       initialise_sffloatrect(0, 0, 276, 44),
                                       initialise_sfintrect(0, 0, 138, 44),
                                       scale);
    ...
    int common_y = 920;
    but_sprite1.d.y = common_y;
    but_sprite2.d.y = common_y;
    but_sprite3.d.y = common_y;
    but_sprite4.d.y = common_y;
    ...
    ends.button_restart = but_sprite_r;
    ...
    bomb_sprite = move_sprite(bomb_sprite, max.w - 30, 650);
    scale.y = sfFalse;
    ...
    spike_ball_sprite = move_sprite(spike_ball_sprite, max.w - 30, 650);
    scale.y = sfFalse;
    scale.x = 60;
    scale.x = 200;
    ...
    window = createWindow(max.w, max.h);
    fb = framebuffer_create(max.w, max.h);
    ...
    unsigned int when_does_it_end = 2000;
    ...
    track_actions_t evt_actions = initialise_tracking(in_game, max.w, max.h);
    while (sfRenderWindow_isOpen(window)) {
        evt_actions.window = window;
        evt_actions.silver = silver_sprite;
        evt_actions.global_speed = is_it.global_speed;
        evt_actions.buttons = initialise_button(but_sprite1, but_sprite2,
                                                but_sprite3, but_sprite4);
        ...
        while (sfRenderWindow_pollEvent(window, &event))
        {
            ...
            but_sprite1 = evt_actions.buttons.button1;
            but_sprite2 = evt_actions.buttons.button2;
            but_sprite3 = evt_actions.buttons.button3;
        ...
        if (evt_actions.in_game == 1) {
            ...
            but_sprite1 = move_sprite_with_struct(but_sprite1);
            but_sprite2 = move_sprite_with_struct(but_sprite2);
            but_sprite3 = move_sprite_with_struct(but_sprite3);
            but_sprite4 = move_sprite_with_struct(but_sprite4);
            ...
            // }
            rock_sprite = is_res_pos_req(rock_sprite, 0, max.w, 0);
            ...
            sfRenderWindow_drawSprite(window, but_sprite1.sprite, NULL);
            sfRenderWindow_drawSprite(window, but_sprite2.sprite, NULL);
            sfRenderWindow_drawSprite(window, but_sprite3.sprite, NULL);
            sfRenderWindow_drawSprite(window, but_sprite4.sprite, NULL);
            ...
            if (score.time == when_does_it_end) {
            ...
            ends.sprite_lost.anim.time = time.lost;
            ends.sprite_won.anim.time = time.won;
            ends = display_correct_ending(ends, time, window);
            time.won = ends.sprite_won.anim.time;
            time.lost = ends.sprite_lost.anim.time;
            time.won++;
            time.lost++;
        }
        ...
        path_sprites = move_two_sprites(path_sprites);
        ice_sprites = move_two_sprites(ice_sprites);
        bkgd_sprites = is_reset_drag_needed(bkgd_sprites, max.w);
        path_sprites = is_reset_drag_needed(path_sprites, max.w);
        ice_sprites = is_reset_drag_needed(ice_sprites, max.w);
    ...
    free_sprite(but_sprite1);
    free_sprite(but_sprite2);
    free_sprite(but_sprite3);
