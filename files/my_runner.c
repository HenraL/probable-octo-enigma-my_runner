...
int launch_game(void) {
    ...
    two_sprites_t cloud_sprites = init_bkgd.background4;
    ...
    unsigned int when_does_it_end = 20000;
    ...
    while (sfRenderWindow_isOpen(window)) {
        ...
        while (sfRenderWindow_pollEvent(window, &event))
        {
            ...
            but_sprite1 = evt_actions.buttons.button2;
            but_sprite1 = evt_actions.buttons.button3;
        ...
        if (evt_actions.in_game == 1) {
            ...
            if (description4_1.x < 1280 && description1_1.x == 100) {
                description4_1.x += 20;
                description4_2.x += 20;
                but_sprite4.d.x += 20;
            }
        ...
        path_sprites = move_two_sprites(path_sprites);
        ice_sprites = move_two_sprites(ice_sprites);
        cloud_sprites = move_two_sprites(cloud_sprites);
        ...
        cloud_sprites = is_reset_drag_needed(cloud_sprites, max.w);
